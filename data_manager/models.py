...
class Layer(models.Model, SiteFlags):
    ...
    vector_outline_color = models.CharField(max_length=7, blank=True, null=True, default=None)
    vector_outline_opacity = models.FloatField(blank=True, null=True, default=None)
    vector_color = models.CharField(max_length=7, blank=True, null=True, default=None)
    vector_fill = models.FloatField(blank=True, null=True, default=None)
    vector_graphic = models.CharField(max_length=255, blank=True, null=True, default=None)
